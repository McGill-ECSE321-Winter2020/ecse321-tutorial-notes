=== Assessing Test Coverage using EclEmma
...
==== Example Gradle Project for Assessing Test Coverage
...
=== Event Registration Application Unit Test Coverage

. Check the test coverage of the service unit tests in the EventRegistration-Backend project.
